...
\begin{frame}{About this}
  \begin{enumerate}[A]
    \pause
    \item\color<1>[rgb]{0.7,0.7,0.7} $(129)_{10}$, $(81)_{16}$, same thing, different looks
    \pause
    \item\color<2>[rgb]{0.7,0.7,0.7} What will be here?
    \pause
    \item\color<3>[rgb]{0.7,0.7,0.7} How?
    \pause
    \item\color<4>[rgb]{0.7,0.7,0.7} Thoughts!
%%  \end{itemize}
  \end{enumerate}
\end{frame}
